...
% -------------------
\def\mfrok{2024}
\def\mfnazov{Structured Point Clouds for Machine Learning Processing of Human Body Data}
\def\mftyp{Diploma Thesis}
\def\mfautor{Bc. Erik Róbert Ján Jakubovský}
\def\mfskolitel{Mgr. Dana Škorvánková }

%ak mate konzultanta, odkomentujte aj jeho meno na titulnom liste
%\def\mfkonzultant{RNDr. Martin Madaras, PhD. }  
...
\vfill
{\bf Acknowledgments:} I would like to thank my supervisor Mgr. Dana škorvánková for her guidance and help while working on this thesis.
